...
void endGame(Graphics g) {
    ...
    String message = "Game over. Press enter to play again.";
    String message2 = "Total score is: " + (food.getScore() - 5); 
    food.setScore(0);
    // Create a new font instance
    Font font = new Font("Serif", Font.ROMAN_BASELINE, 30);
    FontMetrics metrics = getFontMetrics(font);

    Font scorefont = new Font("Serif", Font.ROMAN_BASELINE, 30);
    ...
    g.drawString(message2, (BOARDWIDTH - scoremetrics.stringWidth(message2)) / 2, BOARDHEIGHT / 2);
